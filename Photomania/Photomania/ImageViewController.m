...
- (void)startDownloadingImage
{
    ...
    NSLog(@"Start URL is %@", self.imageURL);
    self.image = nil;
    if (self.imageURL) {
...
{
    NSLog(@"%d",UIInterfaceOrientationIsPortrait(orientation));
    return UIInterfaceOrientationIsPortrait(orientation);
}

//- (void)splitViewController:(UISplitViewController *)svc willHideViewController:(UIViewController *)aViewController invalidatingBarButtonItem:(UIBarButtonItem *)barButtonItem
//{
//    NSLog(@"hide %@",aViewController.title);
